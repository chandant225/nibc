...
class CollegeController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        $colleges_with_courses = College_with_course::where('college_slug',$college->slug)->get();
        return Voyager::view($view, compact('dataType','dataTypeContent','isModelTranslatable','courses','colleges_with_courses'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        College_with_course::where('college_slug',$data->slug)->delete();
                            
        if($request->courses){
            foreach($request->courses as $course){
                 College_with_course::create([
                       'college_slug' => $data->slug,
                       'course_id' => $course,
