<div>
    ...
    @foreach($countries as $country)
     <button style="font-size: 20px;padding: 4px 24px;margin-left:5px;" wire:click="filtercollege('{{$country->slug}}')" class="tab-btn {{$active ==$country->slug ? 'active' : ''}}">{{$country->title}}</button>
