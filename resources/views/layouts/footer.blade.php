            ...
            <div class="row">
              <div class="col-xl-7 col-lg-8">
                <div class="section-title mb-0 style-white">
                  ...
                  <a href="#"><button  data-bs-toggle="modal" data-bs-target="#exampleModal" class="footer-btn">Enroll Today</button></a>
                </div>
              </div>
