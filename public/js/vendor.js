...
/*!
 * Bootstrap v4.0.0-alpha1 (https://getbootstrap.com/)
    ...
    var et = {
        ...
        nt = {
            ...
            findOne: function (t, e) {
                return (
                    void 0 === e && (e = document.documentElement), S.call(e, t)
                );
            },
            ...
            return (
                ...
                (e._getItemIndex = function (t) {
                    return (
                        (this._items =
                            t && t.parentNode
                                ? nt.find(".carousel-item", t.parentNode)
                                : []),
                ...
                (e._setActiveIndicatorElement = function (t) {
                    if (this._indicatorsElement) {
                        for (
                            var e = nt.find(".active", this._indicatorsElement),
                                n = 0;
                            n < e.length;
                            n++
                        )
    ...
    var ht = "collapse",
        ...
        gt = (function () {
            function t(t, e) {
                ...
                for (
                    var n = nt.find('[data-toggle="collapse"]'),
                        i = 0,
                        o = n.length;
                    i < o;
                    i++
            ...
            return (
                ...
                (e._getConfig = function (t) {
                    return (
                        ((t = s(s({}, ft), t)).toggle = Boolean(t.toggle)),
                        v(ht, t, dt),
                        t
                    );
                }),
            ...
            return (
                ...
                (i.show = function () {
                    if (
                        ...
                        if (
                            !q.trigger(this._element, "show.bs.dropdown", i)
                                .defaultPrevented
                        ) {
                            if (!this._inNavbar) {
                                if (void 0 === t)
                ...
                (e.clearMenus = function (t) {
                    if (
                        ...
                        for (
                            var n = nt.find('[data-toggle="dropdown"]'),
                                i = 0,
                                o = n.length;
                            i < o;
                            i++
                        ...
                        (function (t, e) {
                            ...
                            if (-1 !== e.indexOf(n))
                                return (
                                    -1 === Ot.indexOf(n) ||
                                    Boolean(
                                        t.nodeValue.match(Dt) ||
                                            t.nodeValue.match(It)
                                    )
                                );
                            for (
                ...
                function (t) {
                    !(function () {
                        ...
                        a.data("counterup-func", function () {
                            a.data("counterup-nums")
                                ? (a.html(a.data("counterup-nums").shift()),
                                  a.data("counterup-nums").length
                                      ? setTimeout(
            ...
            return function () {
                ...
                return (
                    e.isFunction(arguments[0]) &&
                        ((o = e.extend({}, arguments[1])).handler =
                            arguments[0]),
                    this.each(function () {
