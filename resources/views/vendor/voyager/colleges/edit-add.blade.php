                            ...
                            <div style="display: flex; flex-direction: column;align-content: center;justify-content:space-around; align-items: stretch;"
                                ...
                                @foreach ($courses as $course)
                                    <div class="d-flex flex-row">
                                        <input
                                            {{ $colleges_with_courses->contains('course_id', $course->id) ? 'checked' : '' }}
                                            type="checkbox" name="courses[]" value="{{ $course->id }}">
                                        <p style="display: inline">{{ $course->title . '-' . $course->degree_slug }}</p>
                                        <div>
                                @endforeach
                            </div>
