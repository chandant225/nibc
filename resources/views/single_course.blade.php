...
@section('content')
    <div>
        <!-- page title start -->
        <div class="page-title-area bg-overlay" style="background-image: url('/storage/{{ $course->image }}')">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="tab1-tab" data-toggle="tab" href="#tab1" role="tab"
                                            aria-controls="tab1" aria-selected="true"><i class="fa fa-book"></i>
                                            Overview</a>
                                    </li>
                                    <li class="nav-item">
                                            ...
                                            <div class="media">
                                                <div style="width:50%;" class="media-left">
                                                    <a href="{{ route('course.show', ['slug' => $course->slug]) }}">
                                                        <img src="/storage/{{ $course->image }}" class="w-75 h-100"
                                                            alt="{{ $course->title }}" />
                                                    </a>
                                                </div>
                                                <div class="media-body align-self-center">
                                                    ...
                                                    <div class="post-info">
                                                        <i
                                                            class="fa fa-calendar-times-o"></i>{{ $course->created_at->toDateString() }}
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
